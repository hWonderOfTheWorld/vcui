    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent rounded={"none"} padding={4} maxW="80%" maxH="80%">
        <ModalHeader borderBottomWidth={2} borderBottomColor={"gray.200"}>
          <p className="font-['Satoshi']">{title}</p>
          <p className="font-['Satoshi'] text-base font-normal">{subheading}</p>
        </ModalHeader>
        <ModalCloseButton />
        <ModalBody className="font-['Satoshi'] overflow-auto">
        ...
        <ModalFooter borderTopWidth={2} borderTopColor={"gray.200"}>
          <Button data-testid="button-passport-json-download" width={32} rounded={"base"} mr={3} onClick={onDownload}>
            ...
            &nbsp;
            <span className="font-['Satoshi']">{"Download"}</span>
          </Button>
          <Button
            ...
            onClick={onClose}
          >
            <span className="font-['Satoshi']">{closeButtonText || "Done"}</span>
          </Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
