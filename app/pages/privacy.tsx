...
export default function Privacy() {
  return (
    <div className="font-['Satoshi'] min-h-max min-h-default bg-purple-darkpurple text-gray-100">
      <div className="container mx-auto px-5 py-2">
        <div className="mx-auto flex flex-wrap">
          <div className="w-full py-6 text-white">
            ...
            <div className="font-['Satoshi'] mt-10 leading-relaxed">
              <p className="text-5xl sm:text-7xl md:text-5xl">dPassport Data Deletion Instructions</p>
            </div>
            <div className="font-['Satoshi'] mt-2 text-lg sm:mt-10 sm:text-xl md:mt-10 md:text-xl">
