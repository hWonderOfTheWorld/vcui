...
exports.PLATFORMS = exports.getPlatformSpec = void 0;
const getPlatformSpec = (platformName) => {
    let platformspec = undefined;
    exports.PLATFORMS.forEach((platform) => {
...
exports.getPlatformSpec = getPlatformSpec;
exports.PLATFORMS = [
    {
...
//# sourceMappingURL=platforms-config.js.map