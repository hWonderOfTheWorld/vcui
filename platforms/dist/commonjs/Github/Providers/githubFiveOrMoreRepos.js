...
exports.FiveOrMoreGithubRepos = void 0;
const github_1 = require("./github");
const axios_1 = __importDefault(require("axios"));
class FiveOrMoreGithubRepos {
    constructor(options = {}) {
        this.type = "FiveOrMoreGithubRepos";
        this._options = {};
    ...
    verify(payload, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                verifiedPayload = yield verifyGithubRepoCount(payload.proofs.code, context);
            }
            catch (e) {
                return { valid: false };
            }
...
exports.FiveOrMoreGithubRepos = FiveOrMoreGithubRepos;
const verifyGithubRepoCount = (code, context) => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=githubFiveOrMoreRepos.js.map